...
const initialPeople: UserType[] = [
    ...
    { _id: 0, name: "Саша", age: 3 },
    { _id: 1, name: "Александр", age: 66 },
    { _id: 2, name: "Витя", age: 16 },
    { _id: 3, name: "Коля", age: 24 },
    { _id: 4, name: "Виталий", age: 88 },
    { _id: 5, name: "Эдуард", age: 46 },
    { _id: 6, name: "Витольд", age: 34 },
    { _id: 7, name: "Дмитрий", age: 40 },
    { _id: 8, name: "Анна", age: 55 },
];
